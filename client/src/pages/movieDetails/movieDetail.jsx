...
const MovieDetail = () => {
    ...
    const handleFavourite = ()=>{
        if(checkfav(movie)==false){
            ...
            axios.post("https://movie-app-ds4w.vercel.app/movies/single-favourite-movie",obj)
            .then((res)=>{
                let id = res?.data?.data?._id;
            
                if(id!==""){
                    axios.delete(`https://movie-app-ds4w.vercel.app/movies/delete-favourite-movies/${id}`)
                            .then((res)=>{
    ...
    const handleWatch = ()=>{
        if(checkWatch(movie)==false){
            ...
            axios.post('https://movie-app-ds4w.vercel.app/movies/single-watchlist-movie',obj)
            .then((res)=>{
                let id  = res?.data?.data?._id;
                axios.delete(`https://movie-app-ds4w.vercel.app/movies/delete-watchlist-movies/${id}`)
                        .then((res)=>{
